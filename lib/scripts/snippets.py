...
def create_database(instance_id, database_id):
    ...
    database = instance.database(database_id, ddl_statements=[
        """CREATE TABLE Products (
            ...
            min         INT64,
            max         INT64,
            tax_class   STRING(255) NOT NULL,
            variant_label   STRING(255) NOT NULL,
            org_id      STRING(MAX) NOT NULL
        ) PRIMARY KEY (product_id, org_id)""",
        """CREATE TABLE Variants (
            variant_id  INT64 NOT NULL,
            product_id  INT64 NOT NULL,
            name        STRING(255) NOT NULL,
            option_label    STRING(255) NOT NULL,
            min             INT64,
            max             INT64,
            created_at      TIMESTAMP,
            ...
            deleted_at      TIMESTAMP,
            org_id  STRING(MAX) NOT NULL
        ) PRIMARY KEY (product_id, org_id, variant_id),
        ...
        """CREATE TABLE Items (
            ...
            premium_shipping_cost   FLOAT64,
            variant_id      INT64 NOT NULL,
            product_id      INT64 NOT NULL,
            org_id  STRING(MAX) NOT NULL,
        ) PRIMARY KEY (product_id, org_id, variant_id, item_id),
        INTERLEAVE IN PARENT Variants ON DELETE CASCADE"""
    ])
